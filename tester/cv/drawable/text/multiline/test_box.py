...
from cvlayer.cv.drawable.text.multiline.box import draw_multiline_text_box_coord
...
class DrawableTextMultilineBoxTestCase(TestCase):
    def setUp(self):
    ...
    def test_draw_multiline_text_box(self):
        with TemporaryDirectory() as tmpdir:
            ...
            img1 = bg.copy()
            draw_multiline_text_box_coord(img1, text, x, y)
            ...
            img2 = bg.copy()
            draw_multiline_text_box_coord(img2, text, x, y, anchor_x=0.5, anchor_y=0.5)
            ...
            img3 = bg.copy()
            draw_multiline_text_box_coord(img3, text, x, y, anchor_x=1, anchor_y=1)
